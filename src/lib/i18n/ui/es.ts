...
export const es: Dictionary = {
  ...
  plans: {
    ...
    lecture: {
      ...
      hint: 'Un PDF, EPUB, Word, OpenDocument o HTML, conservado y leído tal cual, día tras día. Tú eliges lo que se lee cada día; sus referencias bíblicas se añaden a tus lecturas con un toque.',
      ...
      rightsTitle: 'Los derechos sobre este documento',
      rightsText: 'Este documento se conservará en tu espacio personal y solo tú lo leerás. Confirma que tienes derecho a ello: un archivo comprado o recibido para tu uso, o libre de derechos. No debe importarse un contenido sobre el que no tengas derechos.',
      rightsConfirm: 'Confirmo que tengo los derechos',
  ...
  planDetail: {
    ...
    zoomIn: 'Ampliar',
    zoomOut: 'Reducir',
    referenceFound: 'Referencia detectada',
    addToReadings: 'Añadir a mis lecturas',
    referenceAdded: 'Añadida a tus lecturas',
    referenceError: 'No se pudo añadir.',
    reference: (l: string) => `Referencia: ${l}`,
