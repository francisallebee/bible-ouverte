...
export const fr = {
  ...
  avance: {
    ...
    import: {
      ...
      fileHint: 'Texte, csv, Word, Excel, PowerPoint, OpenDocument, EPUB — le fichier ne quitte pas l’appareil.',
      fileRefus: {
        'kindle-chiffre': 'Les formats Kindle (mobi, azw) sont chiffrés par Amazon : convertis le livre en EPUB, ou copie son texte.',
        'pdf-a-venir': 'Le PDF n’est pas encore lu : copie son texte, ou attends la version suivante.',
