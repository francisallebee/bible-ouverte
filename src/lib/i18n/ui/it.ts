...
export const it: Dictionary = {
  ...
  avance: {
    ...
    import: {
      ...
      fileHint: 'Testo, csv, Word, Excel, PowerPoint, OpenDocument, EPUB, PDF — il file non lascia il dispositivo.',
      fileRefus: {
      ...
      photoButton: 'Foto',
      photoHint: 'Galleria o fotocamera, una o più pagine — le foto sono lette sul tuo dispositivo e non lo lasciano; il motore e il dizionario della lingua si scaricano una volta.',
      ocrLoading: 'Preparazione della lettura…',
      ocrProgress: (n: number) => `Lettura della foto… ${n} %`,
      ocrPage: (i: number, n: number, pct: number) => `Lettura della pagina ${i} di ${n}… ${pct} %`,
      ...
      audioButton: 'Audio',
      audioHint: 'Una registrazione (mp3, m4a, wav…) trascritta sul tuo dispositivo da un piccolo modello vocale, scaricato una volta (~40 MB). Discreto su una voce chiara, meno su una registrazione lontana.',
      ...
      audioEmpty: 'Nessuna voce riconosciuta in questa registrazione.',
      audioError: 'Impossibile trascrivere la registrazione.',
      audioTooLong: 'Registrazione troppo lunga (30 minuti al massimo): dividila in più file.',
