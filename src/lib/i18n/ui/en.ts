...
export const en: Dictionary = {
  ...
  avance: {
    ...
    import: {
      ...
      fileHint: 'Text, csv, Word, Excel, PowerPoint, OpenDocument, EPUB, PDF — the file never leaves your device.',
      fileRefus: {
      ...
      photoButton: 'Photo',
      photoHint: 'Gallery or camera, one or several pages — photos are read on your device and never leave it; the engine and the language data download once.',
      ocrLoading: 'Getting ready to read…',
      ocrProgress: (n: number) => `Reading the photo… ${n}%`,
      ocrPage: (i: number, n: number, pct: number) => `Reading page ${i} of ${n}… ${pct}%`,
      ...
      audioButton: 'Audio',
      audioHint: 'A recording (mp3, m4a, wav…) transcribed on your device by a small speech model, downloaded once (~40 MB). Fair on a clear voice, less so on a distant recording.',
      ...
      audioEmpty: 'No speech recognised in this recording.',
      audioError: 'The recording could not be transcribed.',
      audioTooLong: 'Recording too long (30 minutes at most): split it into several files.',
