...
export const es: Dictionary = {
  ...
  plans: {
    ...
    documentHint: 'Un texto, Word, PowerPoint, OpenDocument, EPUB o PDF: cada página, título o línea con una referencia se convierte en un día.',
    ...
    documentSplitPage: 'Una página = un día (el PDF se conserva)',
    ...
    documentPagesPerDay: 'Páginas por día',
    documentPageHint: 'El PDF se conserva en tu espacio y se lee tal cual, página a página. Una página sin referencia se une al día siguiente.',
    documentPagesJoined: (n: number) => `${n} página${n !== 1 ? 's' : ''} sin referencia, unida${n !== 1 ? 's' : ''} al día vecino`,
    documentSectionsJoined: (n: number) => `${n} sección${n !== 1 ? 'es' : ''} sin referencia, unida${n !== 1 ? 's' : ''} al día vecino`,
    documentUploadError: 'No se pudo subir el documento. Comprueba la conexión e inténtalo de nuevo.',
    duration: 'Duración',
    durations: {
      '1-year': '1 año',
      '6-months': '6 meses',
  ...
  planDetail: {
    ...
    showDocument: 'Leer el documento del día',
    page: (n: number) => `p. ${n}`,
