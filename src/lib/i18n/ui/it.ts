...
export const it: Dictionary = {
  ...
  plans: {
    ...
    lecture: {
      title: 'Importare un documento',
      hint: 'Un PDF, EPUB, Word, OpenDocument o HTML, conservato e letto così com’è, giorno dopo giorno. Scegli tu cosa leggere ogni giorno; i suoi riferimenti biblici si aggiungono alle tue letture con un tocco.',
      ...
      rightsTitle: 'I diritti su questo documento',
      rightsText: 'Questo documento sarà conservato nel tuo spazio personale e letto solo da te. Conferma di averne il diritto: un file acquistato o ricevuto per il tuo uso, o libero da diritti. Un contenuto di cui non hai i diritti non va importato.',
      rightsConfirm: 'Confermo di avere i diritti',
  ...
  planDetail: {
    ...
    zoomIn: 'Ingrandisci',
    zoomOut: 'Riduci',
    referenceFound: 'Riferimento individuato',
    addToReadings: 'Aggiungi alle mie letture',
    referenceAdded: 'Aggiunto alle tue letture',
    referenceError: 'Aggiunta non riuscita.',
    reference: (l: string) => `Riferimento: ${l}`,
