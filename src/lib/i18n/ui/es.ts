...
export const es: Dictionary = {
  ...
  avance: {
    ...
    import: {
      ...
      fileHint: 'Texto, csv, Word, Excel, PowerPoint, OpenDocument, EPUB, PDF — el archivo no sale del dispositivo.',
      fileRefus: {
      ...
      photoButton: 'Foto',
      photoHint: 'Galería o cámara, una o varias páginas — las fotos se leen en tu dispositivo y no salen de él; el motor y el diccionario del idioma se descargan una vez.',
      ocrLoading: 'Preparando la lectura…',
      ocrProgress: (n: number) => `Leyendo la foto… ${n} %`,
      ocrPage: (i: number, n: number, pct: number) => `Leyendo la página ${i} de ${n}… ${pct} %`,
      ...
      audioButton: 'Audio',
      audioHint: 'Una grabación (mp3, m4a, wav…) transcrita en tu dispositivo por un pequeño modelo de voz, descargado una vez (~40 MB). Aceptable con una voz clara, menos con una grabación lejana.',
      ...
      audioEmpty: 'Ninguna voz reconocida en esta grabación.',
      audioError: 'No se pudo transcribir la grabación.',
      audioTooLong: 'Grabación demasiado larga (30 minutos como máximo): divídela en varios archivos.',
