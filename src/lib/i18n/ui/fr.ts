...
export const fr = {
  ...
  progress: {
    ...
    badges: {
      ...
      'streak-3': { name: 'Régulier', description: "3 jours d'affilée" },
      'streak-7': { name: 'Persévérant', description: "7 jours d'affilée" },
      'streak-30': { name: 'Inarrêtable', description: "30 jours d'affilée" },
      'streak-100': { name: 'Légende vivante', description: "100 jours d'affilée" },
