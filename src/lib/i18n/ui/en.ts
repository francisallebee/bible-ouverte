...
export const en: Dictionary = {
  ...
  avance: {
    ...
    import: {
      ...
      fileHint: 'Text, csv, Word, Excel, PowerPoint, OpenDocument — the file never leaves your device.',
      fileRefus: {
      ...
      photoButton: 'Photo',
      photoHint: 'Gallery or camera — the photo is read on your device and never leaves it; the engine and the language data download once.',
