...
export const ar: Dictionary = {
  ...
  avance: {
    ...
    import: {
      ...
      fileHint: 'نص، csv، Word، Excel، PowerPoint، OpenDocument، EPUB، PDF — لا يغادر الملف جهازك.',
      fileRefus: {
      ...
      photoButton: 'صورة',
      photoHint: 'المعرض أو الكاميرا، صفحة أو عدة صفحات — تُقرأ الصور على جهازك ولا تغادره؛ يُنزَّل المحرك وقاموس اللغة مرة واحدة.',
      ocrLoading: 'جارٍ التحضير للقراءة…',
      ocrProgress: (n: number) => `جارٍ قراءة الصورة… ${n}٪`,
      ocrPage: (i: number, n: number, pct: number) => `جارٍ قراءة الصفحة ${i} من ${n}… ${pct}٪`,
      ...
      audioButton: 'صوت',
      audioHint: 'تسجيل (mp3، m4a، wav…) يُنسخ على جهازك بنموذج كلام صغير يُنزَّل مرة واحدة (~40 ميغابايت). مقبول مع صوت واضح، وأقل مع تسجيل بعيد.',
      ...
      audioEmpty: 'لم يُعرف أي كلام في هذا التسجيل.',
      audioError: 'تعذّر نسخ التسجيل.',
      audioTooLong: 'التسجيل طويل جدًا (30 دقيقة على الأكثر): قسّمه إلى عدة ملفات.',
