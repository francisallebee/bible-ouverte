...
export const fr = {
  ...
  plans: {
    ...
    lecture: {
      ...
      hint: 'Un PDF, un EPUB, un Word, un OpenDocument ou un HTML, gardé et lu tel qu’il est, jour après jour. Tu choisis ce que chaque jour lit ; ses références bibliques s’ajoutent à tes lectures d’un toucher.',
      ...
      rightsTitle: 'Les droits sur ce document',
      rightsText: 'Ce document sera conservé dans ton espace personnel et lu par toi seul. Confirme que tu en as le droit : un fichier que tu as acheté ou reçu pour ton usage, ou libre de droits. Un contenu dont tu n’as pas les droits ne doit pas être importé.',
      rightsConfirm: 'Je confirme, j’ai les droits',
  ...
  planDetail: {
    ...
    zoomIn: 'Agrandir',
    zoomOut: 'Réduire',
    referenceFound: 'Référence repérée',
    addToReadings: 'Ajouter à mes lectures',
    referenceAdded: 'Ajoutée à tes lectures',
    referenceError: 'L’ajout a échoué.',
    reference: (l: string) => `Référence : ${l}`,
