...
export const it: Dictionary = {
  ...
  avance: {
    ...
    import: {
      ...
      fileHint: 'Testo, csv, Word, Excel, PowerPoint, OpenDocument — il file non lascia il dispositivo.',
      fileRefus: {
      ...
      photoButton: 'Foto',
      photoHint: 'Galleria o fotocamera — la foto è letta sul tuo dispositivo e non lo lascia; il motore e il dizionario della lingua si scaricano una volta.',
