...
export const ar: Dictionary = {
  ...
  avance: {
    ...
    import: {
      ...
      fileHint: 'نص، csv، Word، Excel، PowerPoint، OpenDocument — لا يغادر الملف جهازك.',
      fileRefus: {
      ...
      photoButton: 'صورة',
      photoHint: 'المعرض أو الكاميرا — تُقرأ الصورة على جهازك ولا تغادره؛ يُنزَّل المحرك وقاموس اللغة مرة واحدة.',
