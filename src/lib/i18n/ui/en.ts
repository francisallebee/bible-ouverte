...
export const en: Dictionary = {
  ...
  plans: {
    ...
    documentHint: 'A text, Word, PowerPoint, OpenDocument, EPUB or PDF file: every page, heading or line carrying a reference becomes a day.',
    ...
    documentSplit: 'Split',
    documentSplitPage: 'One page = one day (the PDF is kept)',
    ...
    documentPagesPerDay: 'Pages per day',
    documentPageHint: 'The PDF is kept in your space and read as it is, page by page. A page without a reference joins the next day.',
    documentPagesJoined: (n: number) => `${n} page${n !== 1 ? 's' : ''} without a reference, attached to the neighbouring day`,
    documentSectionsJoined: (n: number) => `${n} section${n !== 1 ? 's' : ''} without a reference, attached to the neighbouring day`,
    documentUploadError: 'The document could not be uploaded. Check the connection, then try again.',
    duration: 'Duration',
    durations: {
      '1-year': '1 year',
      '6-months': '6 months',
  ...
  planDetail: {
    ...
    showDocument: 'Read the day’s document',
    page: (n: number) => `p. ${n}`,
