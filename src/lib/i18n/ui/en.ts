...
export const en: Dictionary = {
  ...
  plans: {
    ...
    lecture: {
      ...
      hint: 'A PDF, EPUB, Word, OpenDocument or HTML file, kept and read as it is, day after day. You choose what each day reads; its Bible references join your readings with a tap.',
      ...
      rightsTitle: 'Rights to this document',
      rightsText: 'This document will be kept in your personal space and read by you alone. Confirm that you are entitled to it: a file you bought or received for your own use, or one free of rights. Content you have no rights to must not be imported.',
      rightsConfirm: 'I confirm I have the rights',
  ...
  planDetail: {
    ...
    zoomIn: 'Zoom in',
    zoomOut: 'Zoom out',
    referenceFound: 'Reference found',
    addToReadings: 'Add to my readings',
    referenceAdded: 'Added to your readings',
    referenceError: 'Could not add it.',
    reference: (l: string) => `Reference: ${l}`,
