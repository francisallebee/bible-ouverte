...
export const ar: Dictionary = {
  ...
  language: {
    ...
    bibleStaysFrench:
      'تبقى ترجمات الكتاب المقدس المتاحة بالفرنسية: الواجهة وحدها مترجمة.',
  },
  ...
  settings: {
    ...
    versionsHint:
      'تُنزَّل الترجمة المفعّلة على هذا الجهاز للقراءة دون اتصال — نحو 6 ميغابايت '
  ...
  tour: {
    ...
    steps: {
      ...
      reglages: {
        ...
        points: [
          'فعّل ترجمة أو أزلها: تزن كل واحدة نحو 6 ميغابايت دون اتصال.',
