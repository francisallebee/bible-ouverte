...
export const it: Dictionary = {
  ...
  plans: {
    ...
    documentHint: 'Un testo, Word, PowerPoint, OpenDocument, EPUB o PDF: ogni pagina, titolo o riga con un riferimento diventa un giorno.',
    ...
    documentSplitPage: 'Una pagina = un giorno (il PDF è conservato)',
    ...
    documentContentRefs: 'Solo i riferimenti',
    documentContentFull: 'Il documento intero, giorno per giorno',
    documentPagesPerDay: 'Pagine al giorno',
    documentPageHint: 'Il PDF è conservato nel tuo spazio e si legge così com’è, pagina per pagina. Una pagina senza riferimento si unisce al giorno seguente.',
    documentPagesJoined: (n: number) => `${n} ${n === 1 ? 'pagina senza riferimento, unita' : 'pagine senza riferimento, unite'} al giorno vicino`,
    documentSectionsJoined: (n: number) => `${n} ${n === 1 ? 'sezione senza riferimento, unita' : 'sezioni senza riferimento, unite'} al giorno vicino`,
    documentUploadError: 'Il documento non è stato caricato. Controlla la connessione e riprova.',
    duration: 'Durata',
    durations: {
      '1-year': '1 anno',
      '6-months': '6 mesi',
  ...
  planDetail: {
    ...
    showDocument: 'Leggi il documento del giorno',
    page: (n: number) => `p. ${n}`,
