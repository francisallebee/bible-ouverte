...
export const en: Dictionary = {
  ...
  avance: {
    ...
    import: {
      ...
      fileHint: 'Text, csv, Word, Excel, PowerPoint, OpenDocument, EPUB — the file never leaves your device.',
      fileRefus: {
        'kindle-chiffre': 'Kindle formats (mobi, azw) are encrypted by Amazon: convert the book to EPUB, or copy its text.',
        'pdf-a-venir': 'PDF is not read yet: copy its text, or wait for the next version.',
