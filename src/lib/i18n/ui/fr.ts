...
export const fr = {
  ...
  avance: {
    ...
    import: {
      ...
      fileHint: 'Texte, csv, Word, Excel, PowerPoint, OpenDocument, EPUB, PDF — le fichier ne quitte pas l’appareil.',
      fileRefus: {
      ...
      photoButton: 'Photo',
      photoHint: 'Galerie ou appareil, une ou plusieurs pages — les photos sont lues sur ton appareil et n’en sortent pas ; le moteur et le dictionnaire de la langue se téléchargent une fois.',
      ocrLoading: 'Préparation de la lecture…',
      ocrProgress: (n: number) => `Lecture de la photo… ${n} %`,
      ocrPage: (i: number, n: number, pct: number) => `Lecture de la page ${i} sur ${n}… ${pct} %`,
      ...
      audioButton: 'Audio',
      audioHint: 'Un enregistrement (mp3, m4a, wav…) transcrit sur ton appareil par un petit modèle de parole, téléchargé une fois (~40 Mo). Honnête sur une voix claire, moins sur un enregistrement lointain.',
      ...
      audioEmpty: 'Aucune parole reconnue dans cet enregistrement.',
      audioError: 'L’enregistrement n’a pas pu être transcrit.',
      audioTooLong: 'Enregistrement trop long (30 minutes au plus) : coupe-le en plusieurs fichiers.',
