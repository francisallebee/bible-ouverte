...
export const ar: Dictionary = {
  ...
  plans: {
    ...
    document: 'من مستند',
    documentHint: 'نص أو Word أو PowerPoint أو OpenDocument أو EPUB أو PDF: كل سطر أو عنوان يحمل مرجعًا يصبح يومًا. لا يُحتفظ بشيء من الملف.',
    ...
    lecture: {
      title: 'قراءة مستند',
      hint: 'ملف PDF يُحتفظ به ويُقرأ كما هو، يومًا بعد يوم — بلا مراجع مضافة. أنت تختار ما يُقرأ كل يوم.',
