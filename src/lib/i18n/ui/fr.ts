...
export const fr = {
  ...
  avance: {
    ...
    import: {
      ...
      fileHint: 'Texte, csv, Word, Excel, PowerPoint, OpenDocument — le fichier ne quitte pas l’appareil.',
      fileRefus: {
      ...
      photoButton: 'Photo',
      photoHint: 'Galerie ou appareil — la photo est lue sur ton appareil et n’en sort pas ; le moteur et le dictionnaire de la langue se téléchargent une fois.',
