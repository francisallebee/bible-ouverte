...
export const it: Dictionary = {
  ...
  avance: {
    ...
    import: {
      ...
      fileHint: 'Testo, csv, Word, Excel, PowerPoint, OpenDocument, EPUB — il file non lascia il dispositivo.',
      fileRefus: {
        'kindle-chiffre': 'I formati Kindle (mobi, azw) sono cifrati da Amazon: converti il libro in EPUB, o copia il suo testo.',
        'pdf-a-venir': 'Il PDF non è ancora letto: copia il suo testo, o attendi la prossima versione.',
