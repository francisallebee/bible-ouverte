...
export const it: Dictionary = {
  ...
  language: {
    ...
    bibleStaysFrench:
      'Le versioni bibliche disponibili restano in francese: viene tradotta '
      + "solo l'interfaccia.",
  },
  ...
  settings: {
    ...
    versionsHint:
      ...
      + 'lettura offline — circa 6 MB ciascuna. Disattivarla libera quello '
      + 'spazio.',
  ...
  progress: {
    ...
    badges: {
      ...
      'streak-3': { name: 'Costante', description: '3 giorni di fila' },
      'streak-7': { name: 'Perseverante', description: '7 giorni di fila' },
      'streak-30': { name: 'Inarrestabile', description: '30 giorni di fila' },
      'streak-100': { name: 'Leggenda vivente', description: '100 giorni di fila' },
    ...
    steps: {
      ...
      reglages: {
        ...
        body:
          ...
          + "dell'account.",
        points: [
          'Attiva o togli una traduzione: ciascuna pesa circa 6 MB offline.',
