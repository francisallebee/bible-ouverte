...
export const it: Dictionary = {
  ...
  plans: {
    ...
    lecture: {
      ...
      choose: 'Scegli il PDF',
      ofPages: (n: number) => `${n} pagin${n !== 1 ? 'e' : 'a'}`,
      days: 'I giorni',
      errors: {
        format: 'Per ora solo un PDF può essere letto così com’è.',
