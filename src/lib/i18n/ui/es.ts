...
export const es: Dictionary = {
  ...
  avance: {
    ...
    import: {
      ...
      fileHint: 'Texto, csv, Word, Excel, PowerPoint, OpenDocument — el archivo no sale del dispositivo.',
      fileRefus: {
      ...
      photoButton: 'Foto',
      photoHint: 'Galería o cámara — la foto se lee en tu dispositivo y no sale de él; el motor y el diccionario del idioma se descargan una vez.',
