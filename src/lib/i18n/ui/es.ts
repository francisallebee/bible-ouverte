...
export const es: Dictionary = {
  ...
  avance: {
    ...
    import: {
      ...
      fileHint: 'Texto, csv, Word, Excel, PowerPoint, OpenDocument, EPUB — el archivo no sale del dispositivo.',
      fileRefus: {
        'kindle-chiffre': 'Los formatos Kindle (mobi, azw) están cifrados por Amazon: convierte el libro a EPUB, o copia su texto.',
        'pdf-a-venir': 'El PDF aún no se lee: copia su texto, o espera la próxima versión.',
